    ...
    public static void main(String[] args) {
        try {
            ...
            while (i < count1) {
                ...
                if ((rs1.getString("LINE").compareTo("41") != 0 && rs1.getString("METHOD_NAME").compareTo("run") != 0) && (rs2.getString("LINE").compareTo("41") != 0 && rs2.getString("METHOD_NAME").compareTo("run") != 0)) {
